  ...
  <div class="flex flex-col min-h-screen p-6">
    ...
    <section class="p-6 mb-6 bg-gray-800 rounded-lg">
      <div class="flex items-center space-x-4">
        ...
        <!-- Settings Icon -->
        <a href="settings.html" class="text-gray-400 transition hover:text-violet-accent">
        ...
        <div class="overflow-hidden bg-gray-700 rounded-lg shadow-lg">
          ...
          <div class="p-4">
            ...
            <div class="flex mt-4 space-x-2">
              <button class="px-4 py-2 transition rounded bg-violet-accent hover:bg-violet-700">View Details</button>
