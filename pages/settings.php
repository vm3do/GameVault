...
if (isset($_POST['update'])) {
  $user->updateInfo($_POST['update'], $_POST['username'], $_POST['email'], $_POST['password']);
}
?>
      ...
      <form action="settings.php" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div>
          ...
          <div class="flex items-center space-x-4">
            ...
            <!-- File Input -->
            <div>
              <input type="file" id="file-input" name="profile_pic" class="hidden" accept="image/*"
        ...
        <!-- Save Button -->
        <button type="submit" name="update" value="<?= $info['id'] ?>"
  ...
  <script>
    function previewImage(event) {
      ...
      reader.onload = function () {
        const preview = document.getElementById("profile-prev");
